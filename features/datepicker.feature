...
#   When I add "2022-01-01" to the inputfield "input"
...
#   When I open the site "/datepicker" with inputfield "input" set to "2022-04-01"
  #   Then I expect that element "[data-press-datepicker-input]" contains the text "2022-04-01"
  ...
  Scenario: Submit a start-of-month date with fancy interactions
    ...
    Then I expect that element "[name=input]" contains the text "2022-01-01"
...
#   And I click on the button "[type=submit]"
#   Then I expect the server received a form parameter named "input" with a value of "2022-01-15"
...
#   And I click on the button "[type=submit]"
#   Then I expect the server received a form parameter named "input" with a value of "2022-01-31"
